...
async function run() {
    const patchContent = await fs.readFile(fileURLToPath(new URL(new URL('monaco-editor-treemending.patch', import.meta.url).href, import.meta.url)));
    ...
    if ("0.44.0" !== monacoVersion) {
        console.error(`Wrong monaco-editor version: expecting ${"0.44.0"}, got ${monacoVersion}`);
        process.exit(1);
    }
