...
import { nullExtensionDescription, toExtensionDescription, IExtensionService } from '../vscode/src/vs/workbench/services/extensions/common/extensions.js';
...
import { AbstractExtensionService, DeltaExtensionsQueueItem, ResolvedExtensions } from '../vscode/src/vs/workbench/services/extensions/common/abstractExtensionService.js';
...
import { IExtensionManifestPropertiesService, ExtensionManifestPropertiesService } from '../vscode/src/vs/workbench/services/extensions/common/extensionManifestPropertiesService.js';
...
import { BrowserExtensionHostFactory, BrowserExtensionHostKindPicker } from '../vscode/src/vs/workbench/services/extensions/browser/extensionService.js';
import { FetchFileSystemProvider } from '../vscode/src/vs/workbench/services/extensions/browser/webWorkerFileSystemProvider.js';
...
import '../vscode/src/vs/workbench/services/themes/common/colorExtensionPoint.js';
import '../vscode/src/vs/workbench/services/themes/common/iconExtensionPoint.js';
import '../vscode/src/vs/workbench/services/extensions/common/extensionsRegistry.js';
import '../vscode/src/vs/platform/theme/common/tokenClassificationRegistry.js';
import '../vscode/src/vs/workbench/contrib/codeEditor/browser/languageConfigurationExtensionPoint.js';
import '../vscode/src/vs/workbench/api/browser/statusBarExtensionPoint.js';
...
import '../vscode/src/vs/workbench/api/browser/mainThreadChatProvider.js';
import '../vscode/src/vs/workbench/api/browser/mainThreadChatSlashCommands.js';
import '../vscode/src/vs/workbench/api/browser/mainThreadChatAgents.js';
...
import '../vscode/src/vs/workbench/api/browser/mainThreadChat.js';
...
import '../vscode/src/vs/workbench/api/browser/mainThreadProfilContentHandlers.js';
...
import '../vscode/src/vs/workbench/api/browser/mainThreadIssueReporter.js';
...
let SimpleExtensionService = class SimpleExtensionService extends AbstractExtensionService {
    constructor(workerConfig, instantiationService, notificationService, browserEnvironmentService, telemetryService, extensionEnablementService, fileService, productService, extensionManagementService, contextService, configurationService, extensionManifestPropertiesService, logService, remoteAgentService, remoteExtensionsScannerService, lifecycleService, remoteAuthorityResolverService, userDataInitializationService, dialogService) {
        ...
        const extensionHostFactory = new LocalBrowserExtensionHostFactory(workerConfig, extensionsProposedApi, async () => [], () => this._getExtensionRegistrySnapshotWhenReady(), instantiationService, remoteAgentService, remoteAuthorityResolverService, extensionEnablementService, logService);
...
registerAssets({
    'vs/workbench/services/extensions/worker/webWorkerExtensionHostIframe.html': () => changeUrlDomain(new URL(new URL('../assets/webWorkerExtensionHostIframe.html', import.meta.url).href, import.meta.url).href, iframeAlternateDomains)
});
