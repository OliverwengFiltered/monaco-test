...
import { makeEmptyCounts, terminalStatePriorities, maxPriority } from './testingStates.js';
import { TestResultItem, getMarkId } from './testTypes.js';
({
    buffers: [],
    length: 0,
...
class LiveTestResult extends Disposable {
    get completedAt() {
...
export { LiveTestResult, TaskRawOutput };
