...
import { CommentNode, ResourceWithCommentThreads, CommentsModel } from '../common/commentModel.js';
...
import { openLinkFromMarkdown } from 'monaco-editor/esm/vs/editor/contrib/markdownRenderer/browser/markdownRenderer.js';
const COMMENTS_VIEW_ID = 'workbench.panel.comments';
const COMMENTS_VIEW_STORAGE_ID = 'Comments';
const COMMENTS_VIEW_ORIGINAL_TITLE = 'Comments';
const COMMENTS_VIEW_TITLE = ( nls.localize('comments.view.title', "Comments"));
...
export { COMMENTS_VIEW_ID, COMMENTS_VIEW_ORIGINAL_TITLE, COMMENTS_VIEW_STORAGE_ID, COMMENTS_VIEW_TITLE, CommentNodeRenderer, CommentsList, Filter, ResourceWithCommentsRenderer };
