...
import { Disposable, DisposableMap, DisposableStore } from 'monaco-editor/esm/vs/base/common/lifecycle.js';
import { Schemas } from 'monaco-editor/esm/vs/base/common/network.js';
import { basename } from 'monaco-editor/esm/vs/base/common/path.js';
import { isEqualOrParent, isEqual, toLocalResource } from 'monaco-editor/esm/vs/base/common/resources.js';
...
( (function(HotExitState) {
    ...
    })(HotExitState.Type || (HotExitState.Type = {})));
    HotExitState.Allowed = ( Object.freeze({ type: 0  }));
    HotExitState.NotAllowed = ( Object.freeze({ type: 1  }));
    class Pending {
