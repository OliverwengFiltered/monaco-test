...
registerColor('commandCenter.foreground', { dark: TITLE_BAR_ACTIVE_FOREGROUND, hcDark: TITLE_BAR_ACTIVE_FOREGROUND, light: TITLE_BAR_ACTIVE_FOREGROUND, hcLight: TITLE_BAR_ACTIVE_FOREGROUND }, ( localize('commandCenter-foreground', "Foreground color of the command center")), false);
registerColor('commandCenter.activeForeground', { dark: MENUBAR_SELECTION_FOREGROUND, hcDark: MENUBAR_SELECTION_FOREGROUND, light: MENUBAR_SELECTION_FOREGROUND, hcLight: MENUBAR_SELECTION_FOREGROUND }, ( localize(
    'commandCenter-activeForeground',
    "Active foreground color of the command center"
)), false);
registerColor('commandCenter.inactiveForeground', { dark: TITLE_BAR_INACTIVE_FOREGROUND, hcDark: TITLE_BAR_INACTIVE_FOREGROUND, light: TITLE_BAR_INACTIVE_FOREGROUND, hcLight: TITLE_BAR_INACTIVE_FOREGROUND }, ( localize(
...
registerColor('commandCenter.inactiveBorder', { dark: ( transparent(TITLE_BAR_INACTIVE_FOREGROUND, .25)), hcDark: ( transparent(TITLE_BAR_INACTIVE_FOREGROUND, .25)), light: ( transparent(TITLE_BAR_INACTIVE_FOREGROUND, .25)), hcLight: ( transparent(TITLE_BAR_INACTIVE_FOREGROUND, .25)) }, ( localize(
