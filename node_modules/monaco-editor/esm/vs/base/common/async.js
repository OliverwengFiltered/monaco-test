...
export class ResourceQueue {
    ...
    queueFor(resource, extUri = defaultExtUri) {
        ...
        if (!queue) {
            ...
            const drainListener = Event.once(queue.onDrained)(() => {
                ...
                (_a = this.drainListeners) === null || _a === void 0 ? void 0 : _a.deleteAndDispose(drainListenerId);
                if (((_b = this.drainListeners) === null || _b === void 0 ? void 0 : _b.size) === 0) {
    ...
    dispose() {
        ...
        // disposed.
        this.releaseDrainers();
        (_a = this.drainListeners) === null || _a === void 0 ? void 0 : _a.dispose();
    }
}
...
export class TaskSequentializer {
    isRunning(taskId) {
        ...
        if (typeof taskId === 'number') {
            return ((_a = this._running) === null || _a === void 0 ? void 0 : _a.taskId) === taskId;
        }
        return !!this._running;
    }
    get running() {
        var _a;
        return (_a = this._running) === null || _a === void 0 ? void 0 : _a.promise;
    }
    cancelRunning() {
        var _a;
        (_a = this._running) === null || _a === void 0 ? void 0 : _a.cancel();
    }
    run(taskId, promise, onCancel) {
        this._running = { taskId, cancel: () => onCancel === null || onCancel === void 0 ? void 0 : onCancel(), promise };
    ...
    join() {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            return (_b = (_a = this._queued) === null || _a === void 0 ? void 0 : _a.promise) !== null && _b !== void 0 ? _b : (_c = this._running) === null || _c === void 0 ? void 0 : _c.promise;
        });
    }
}
//#endregion
