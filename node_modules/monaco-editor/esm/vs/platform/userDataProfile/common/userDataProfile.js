...
let UserDataProfilesService = class UserDataProfilesService extends Disposable {
    ...
    updateProfile(profileToUpdate, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            profile = toUserDataProfile(profile.id, (_a = options.name) !== null && _a !== void 0 ? _a : profile.name, profile.location, this.profilesCacheHome, {
                shortName: (_b = options.shortName) !== null && _b !== void 0 ? _b : profile.shortName,
                icon: options.icon === null ? undefined : (_c = options.icon) !== null && _c !== void 0 ? _c : profile.icon,
                transient: (_d = options.transient) !== null && _d !== void 0 ? _d : profile.isTransient,
                useDefaultFlags: (_e = options.useDefaultFlags) !== null && _e !== void 0 ? _e : profile.useDefaultFlags
            }, this.defaultProfile);
            this.updateProfiles([], [], [profile]);
            return profile;
        });
